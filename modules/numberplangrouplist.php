...
function GetNumberPlanGroupList()
{
	global $DB;
...
$pagelimit = (!isset($CONFIG['phpui']['numberplangrouplist_pagelimit']) ? $listdata['total'] : $CONFIG['phpui']['numberplangrouplist_pagelimit']);
...
$numberplangrouplist = GetNumberPlanGroupList();
